...
const Button = (
	...
	const variantClassNames = {
		primary:
			'text-white bg-accent focus-visible:ring-accent border border-solid border-accent',
		white: 'text-accent bg-white border border-solid border-accent focus-visible:ring-accent',
