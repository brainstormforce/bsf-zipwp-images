...
return [
	...
	*/
	...
	'remove'       => [
		...
		/**
		 * [Reason] A URL inside the phpinsights package was returning a 404 error, 
		 * causing phpinsights to trigger a security issue and fail the check.
		 * 
		 * The developer team has reported this issue, but it hasn't been resolved yet. 
		 * As a temporary workaround, the team suggests ignoring this issue.
		 */
